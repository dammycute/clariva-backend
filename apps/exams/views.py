...
STAFF_ROLES = {'school_admin', 'admin_officer', 'principal', 'teacher', 'bursary', 'super_admin'}
...
class ExamSessionViewSet(SchoolFilterMixin, viewsets.ModelViewSet):
    ...
    def submit(self, request, pk=None):
        ...
        if exam.component and exam.subject:
            ...
            grade_kwargs = {}
            if exam.component in ('ca1', 'ca2', 'assignment', 'exam'):
                grade_kwargs[exam.component] = scaled_score
            ...
            grade_obj, created = Grade.objects.get_or_create(
                ...
                defaults=grade_kwargs,
            )
            if not created and grade_obj.results_status != 'approved':
                for field, value in grade_kwargs.items():
